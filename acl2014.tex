...
\eat{\includegraphics[width=.48\textwidth]{graphs/drink_CHI}
...
\begin{tabular}[c]{@{}c@{}}Wein, \\ Glas, \\ Wasser, \\ \\ Kaffee, \\ Bier, \\ Komm, \\ Trink, \\ Schluck, \\ Milch, \\ Schnaps\end{tabular} & \begin{tabular}[c]{@{}c@{}}vin, \\ verre, \\ au, \\ sang, \\ lait, \\ coup, \\ café, \\ hé, \\ calice, \\ aux\end{tabular} & 
\begin{tabular}[c]{@{}c@{}}???, \\ ????, \\ ????, \\ ???, \\ ?????, \\ ????, \\ ????, \\ ????, \\????, \\ ???\end{tabular} & 
\begin{tabular}[c]{@{}c@{}}vino, \\ acqua, \\ icchiere, \\ sangue, \\ caffè, \\ calice, \\ acque, \\ latte, \\ irra, \\ cicuta\end{tabular} & 
\begin{tabular}[c]{@{}c@{}}?, \\ ?, \\ ?, \\ ??, \\ ?, \\ ??, \\ ??, \\ ??, \\ ?, \\ ?\end{tabular} & 
\begin{tabular}[c]{@{}c@{}}agua, \\ vino, \\ á, \\ sangre, \\ aguas, \\ vaso, \\ cicuta, \\ mas, \\ leche, \\ copa\end{tabular} & 
