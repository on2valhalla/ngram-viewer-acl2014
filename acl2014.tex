...
>>>>>>> d638b9e0c8bc8a2d7cdb06bd212c9278274312e6
...
\includegraphics[width=1\textwidth]{graphs/President*1950}
\includegraphics[width=1\textwidth]{graphs/President*1800}
...
\begin{CJK}{UTF8}{gbsn} \begin{tabular}[c]{@{}c@{}} 酒, \\  茶, \\  水, \\  咖啡, \\  人, \\  别人, \\  啤酒, \\  女儿, \\  烟, \\  们  \end{tabular} \end{CJK}& 
\begin{tabular}[c]{@{}c@{}}agua, \\ vino, \\ \'a, \\ sangre, \\ aguas, \\ vaso, \\ cicuta, \\ mas, \\ leche, \\ copa\end{tabular} & 
\begin{tabular}[c]{@{}c@{}}\heb{יין}\\ \heb{מים} \\ \heb{כוס}\\ \heb{ה} \\ \heb{תה}\\ \heb{קפה} \\ \heb{כוסות} \\ \heb{שכר} \\ \heb{מיס}\\ \heb{חלב}\end{tabular} \\ \hline
\end{tabular}
\end{table*}
