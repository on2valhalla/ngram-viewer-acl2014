...
\label{sec:features}
Here, we describe in detail the novel aspects of the Ngram Viewer introduced in this demonstration paper.
\begin{table*}
\small
\centering
\begin{tabular}{|c|c|}
...
One of the primary benefits of searching with the capitalization feature is the combination of multiple searches in one. As in Figure \ref{fig:apple}, using the feature allows for immediate identification of changing orthographic usage of a word or phrase, which in this case shows the arrival of a company in the late 20th century.
