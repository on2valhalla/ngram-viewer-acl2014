...
\end{table*}
\footnotetext{Queries were initiated by translation from `drink' using Google Translate \jmcomment{is there a reference we should cite here for google translate?}}
