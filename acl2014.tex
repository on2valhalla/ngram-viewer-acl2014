...
{\RawCaption{
\caption{Example queries highlighting the new functionality.\footnote{These figures show fewer results than returned by the Ngram Viewer due to space considerations.} Figures need to be updated. Just a placeholder for now.}\label{fig:examples}}}
\end{figure*}
\end{savenotes}
...
\begin{figure}
\includegraphics[width=\textwidth,keepaspectratio=true]{system_architecture}
...
\includegraphics[width=.49\textwidth]{graphs/President*1950}
