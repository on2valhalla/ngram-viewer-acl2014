...
One of the primary benefits of capitalization searching is the combination of multiple searches in one, which allows the user to compare completely case-insensitive usages of two different phrases. An alternative use is in Figure~\ref{fig:oracle}, where using capitalization searches allows for immediate identification of changing orthographic usage of a word or phrase, which in this case shows the arrival of a new capitalization trend due to a company name, Oracle.

Searches using the inflection feature can also be useful for
