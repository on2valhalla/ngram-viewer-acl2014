...
\begin{savenotes}
\begin{figure*}
\includegraphics[width=0.48\textwidth]{graphs/university}\hspace{2\unitlength}%
\includegraphics[width=0.48\textwidth]{graphs/book}\vspace{2\unitlength}\par
\includegraphics[width=0.48\textwidth]{graphs/fitzgerald}\hspace{2\unitlength}%
\parbox[b][60\unitlength]{.48\textwidth}%
{\RawCaption{
